...
<body>
  <header>
    ...
    <h1>Major Crops In Meghalaya</h1>
  </header>
  <div class="container">
    <div class="crop-card">
    ...
    <div class="crop-card">
      <img src="https://assets.sentinelassam.com/h-upload/2021/02/01/1600x960_194824-tea-garden-1.jpg" alt="Crop 2"
        class="crop-image" />
