...
<body
    ...
    <p align="center" style="font-size: 70px;color: #e76528;">HARYANA</p>
    <div class="card">

        <img src="https://static3.bigstockphoto.com/6/5/3/large2/356815772.jpg">
        <div class="content">
            Haryana is a northern Indian state known for its rich cultural heritage and historical significance.
    ...
    <div class="card1">
        ...
        <div class="content" style="overflow:scroll">
            <ul>
                ...
                <li><a href="haryanas.php" style="font-size: 40px;">SOIL</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li><a href="haryanaw.php" style="font-size: 40px;">WEATHER</a></li>
            </ul>
        </div>
    </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li>Oilseeds</li>
                <li><a href="haryanac.php" style="font-size: 40px;">CROPS</a></li>
            </ul>
        </div>
    </div>
