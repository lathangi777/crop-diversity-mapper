...
<body
    style="background-image: url( https://images.lifestyleasia.com/wp-content/uploads/sites/7/2022/03/31174154/Hidden-Gems-Himachal.jpg); background-size:cover;background-position: absolute;height:100vh;background-repeat: no-repeat;background-attachment: fixed;">
      <div>
    ...
    <p align="center" style="font-size: 70px;color: #e76528;">HIMACHAL PRADESH</p>
    <div class="card">

        <img src="https://www.traveldealsfinder.com/wp-content/uploads/2012/09/himachal-location1.jpg">
        <div class="content">

            Himachal Pradesh, nestled in the lap of the Himalayas, is a picturesque Indian state renowned for its
            breathtaking natural beauty. With snow-capped peaks, lush valleys, and pristine rivers, it is a haven for
            nature enthusiasts and adventure seekers alike. The state boasts charming hill stations like Shimla, Manali,
            and Dharamshala, which attract tourists throughout the year.
    ...
    <div class="card1">
        ...
        <div class="content" style="overflow:scroll">
            <ul>
                ...
                <li><a href="himachals.php" style="font-size: 40px;">SOIL</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li><a href="himachalw.php" style="font-size: 40px;">WEATHER</a></li>
            </ul>
        </div>
    </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li><a href="himachalc.php" style="font-size: 40px;">CROPS</a></li>
            </ul>
        </div>
    </div>
