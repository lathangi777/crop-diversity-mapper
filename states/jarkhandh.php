...
<body
    style="background-image: url(https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_5/IMAGE_1654581286.jpg ); background-size:cover;background-position: absolute;height:100vh;background-repeat: no-repeat;background-attachment: fixed;">
    <div>
    ...
    <p align="center" style="font-size: 70px;color: #e76528;">JARKHANDH</p>
    <div class="card">

        <img src="https://c8.alamy.com/comp/2A6XMJD/jharkhand-red-highlighted-in-map-of-india-2A6XMJD.jpg">
        <div class="content">

            Jharkhand is a state located in eastern India, known for its rich cultural heritage and natural beauty.
            It was carved out of the southern part of Bihar in the year 2000, becoming the 28th state of India.
        </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content" style="overflow:scroll">
            <ul>
                ...
                <li><a href="Jarkhands.php" style="font-size: 40px;">SOIL</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li><a href="jarkhandhw.php" style="font-size: 40px;">WEATHER</a></li>
            </ul>
        </div>
    </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li>Oilseeds</li>
                <li><a href="jarkhandhc.php" style="font-size: 40px;">CROPS</a></li>
            </ul>
        </div>
    </div>
