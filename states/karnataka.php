...
<body style="
      background-image: url(https://media.easemytrip.com/media/Blog/India/636927396474187392/636927396474187392ozkrTH.jpg);
            ...
            <div class="flip-card">
                ...
                " />
                    ...
                    <div class="flip-card-back">
                        ...
                        <a href="karnatakas.php" style="font-size: 30px; font-weight: 30px">SOIL</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flip-card1">
                <div class="flip-card-inner1">
                    <div class="flip-card-front1">
                        <img src="https://hsss.me/wp-content/uploads/2021/01/irrigation-system.jpg" alt="irrigation"
                            style="
                  width: 300px;
                  height: 300px;
                  border-radius: 20px;
            ...
            <div class="flip-card2">
                <div class="flip-card-inner2">
                    <div class="flip-card-front2">
                        <img src="https://eos.com/wp-content/uploads/2020/03/dna-genetic-plants.jpg" alt="irrigation"
                            style="
                  width: 300px;
                  height: 300px;
                  border-radius: 20px;
                ...
                " />
                    ...
                    <div class="flip-card-back2">
                        ...
                        <a href="karnatakac.php" style="font-size: 30px; font-weight: 30px">CROPS</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flip-card3">
                <div class="flip-card-inner3">
                    <div class="flip-card-front3">
                        <img src="https://media.hswstatic.com/eyJidWNrZXQiOiJjb250ZW50Lmhzd3N0YXRpYy5jb20iLCJrZXkiOiJnaWZcL3JlZGVmaW5lZm91cnNlYXNvbnMtMS5qcGciLCJlZGl0cyI6eyJyZXNpemUiOnsid2lkdGgiOjgyOH19fQ=="
                ...
                " />
                    ...
                    <div class="flip-card-back3">
                        ...
                        <a href="karnatakaw.php" style="font-size: 30px; font-weight: 30px">WEATHER</a>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <a href="index.html" style="float: center; font-size: 300%; color: black; margin-left: 45%">home</a>
