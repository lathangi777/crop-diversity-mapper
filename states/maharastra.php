...
<body style="
      background-image: url(https://assets.traveltriangle.com/blog/wp-content/uploads/2018/01/1200px-Raigad_fort_towers.jpg);
            ...
            <div class="flip-card">
                ...
                " />
                    ...
                    <div class="flip-card-back">
                        ...
                        <a href="maharastras.php" style="font-size: 30px; font-weight: 30px">SOIL</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flip-card2">
                ...
                " />
                    ...
                    <div class="flip-card-back2">
                        ...
                        <a href="maharastrac.php" style="font-size: 30px; font-weight: 30px">CROPS</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flip-card3">
                ...
                " />
                    ...
                    <div class="flip-card-back3">
                        ...
                        <a href="maharastraw.php" style="font-size: 30px; font-weight: 30px">WEATHER</a>
                    </div>
                </div>
            </div>
        </div>
