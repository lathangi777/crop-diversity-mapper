...
<body
    style="background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/Konarka_Temple.jpg/640px-Konarka_Temple.jpg); background-size:cover;background-position: absolute;height:100vh;background-repeat: no-repeat;background-attachment: fixed;">
    <div>
    ...
    <p align="center" style="font-size: 70px;color: #e76528;">ODISHA</p>

    <div class="card">

        <img src="https://c8.alamy.com/comp/2A6XMC3/odisha-red-highlighted-in-map-of-india-2A6XMC3.jpg">
        <div class="content">
            Odisha, located on the eastern coast of India, is known for its rich cultural heritage and ancient
            temples,
            including the famous Jagannath Temple in Puri.
            The state boasts a diverse landscape, with a long coastline along the Bay of Bengal, lush green forests,
            and
            picturesque hills in regions like the Eastern Ghats.
    ...
    <div class="card1">
        ...
        <div class="content" style="overflow:scroll">
            <ul>
                ...
                <li><a href="odishas.php" style="font-size: 40px;">SOIL</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li><a href="odishaw.php" style="font-size: 40px;">WEATHER</a></li>
            </ul>
        </div>
    </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li>Oilseeds</li>
                <li><a href="odishac.php" style="font-size: 40px;">CROPS</a></li>
            </ul>
        </div>
    </div>
