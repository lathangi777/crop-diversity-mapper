...
<body
    style="background-image: url( https://media.istockphoto.com/id/535570117/photo/golden-temple-in-amritsar-punjab-india.jpg?s=612x612&w=0&k=20&c=TAgZK64Qz6YsljOK1rXZrrW1u1YSlb9e_YBEmm2pfBw=); background-size:cover;background-position: absolute;height:100vh;background-repeat: no-repeat;background-attachment: fixed;">
    <div>
    ...
    <p align="center" style="font-size: 70px;color: #e76528;">PUNJAB</p>
    <div class="card">

        <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/India_Punjab_locator_map.svg/1855px-India_Punjab_locator_map.svg.png">
        <div class="content">

            Punjab, a northern Indian state, is renowned for its rich cultural heritage and vibrant traditions. With a
            history dating back centuries, it has been a melting pot of cultures and civilizations. Known as the "Land
            of Five Rivers" due to the Beas, Chenab, Jhelum, Ravi, and Sutlej rivers that flow through it, Punjab boasts
            fertile plains that have made it the "Granary of India
    ...
    <div class="card1">
        ...
        <div class="content" style="overflow:scroll">
            <ul>
                ...
                <li><a href="punjabs.php" style="font-size: 40px;">SOIL</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li><a href="punjabw.php" style="font-size: 40px;">WEATHER</a></li>
            </ul>
        </div>
    </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li>Oilseeds</li>
                <li><a href="punjabc.php" style=" font-size: 40px;">CROPS</a></li>
            </ul>
        </div>
    </div>
