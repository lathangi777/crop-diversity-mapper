...
<body style="
      background-image: url(https://www.adotrip.com/public/images/state/contentImg/5eb01c02257f0.jpg);
            ...
            <div class="flip-card">
                ...
                " />
                    ...
                    <div class="flip-card-back">
                        ...
                        <a href="tamils.php" style="font-size: 30px; font-weight: 30px">SOIL</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flip-card2">
                ...
                " />
                    ...
                    <div class="flip-card-back2">
                        ...
                        <div>
                            <a href="tamilc.php" style="font-size: 30px; font-weight: 30px">CROPS</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flip-card3">
                ...
                " />
                    ...
                    <div class="flip-card-back3">
                        ...
                        <div>
                            <a href="tamilw.php" style="font-size: 30px; font-weight: 30px">WEATHER</a>
                        </div>
                    </div>
                </div>
            </div>
