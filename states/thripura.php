...
<body
    style="background-image: url(https://upload.wikimedia.org/wikipedia/commons/2/2b/Tripura_State_Museum_Agartala_Tripura_India.jpg); background-size:cover;background-position: absolute;height:100vh;background-repeat: no-repeat;background-attachment: fixed;">
    <div>
    ...
    <p align="center" ; style="font-size: 70px;color: #e76528;">Tripura</p>
    <div class="card">

        <img
            src="https://cdn3.vectorstock.com/i/1000x1000/71/92/tripura-state-location-within-india-3d-map-vector-35747192.jpg">
        <div class="content">
            Tripura is a state located in the northeastern region of India. It is known for its rich cultural heritage,
            diverse tribal communities, and lush green landscapes.The state is characterized by its hilly terrain, with
            the Jampui Hills being the highest peak. It is part of the Eastern Himalayas and features dense forests,
            rivers, and a diverse range of flora and fauna.
        </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content" style="overflow:scroll">
            <ul>
                ...
                <li>Sandy Soil</li>
                <li>Silt Soil</li>
                <li><a href="thripuras.php" style="font-size: 40px;">SOIL</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li><a href="thripuraw.php" style="font-size: 40px;">WEATHER</a></li>
            </ul>
        </div>
    </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li>Oilseeds</li>
                <li><a href="thripurac.php" style="font-size: 40px;">CROPS</a></li>
            </ul>
        </div>
    </div>
