...
<body
    style="background-image: url( https://upload.wikimedia.org/wikipedia/commons/6/6e/Auli%2C_India.jpg); background-size:cover;background-position: absolute;height:100vh;background-repeat: no-repeat;background-attachment: fixed;">
    <div>
    ...
    <p align="center" style="font-size: 60px;color: #e76528;margin-left: 30px;margin-bottom: 30px;">UTTARAKAND</p>
    <div class="card">

        <img src="https://www.traveldealsfinder.com/wp-content/uploads/2012/09/locaiton1.jpg">
        <div class="content">
            Uttarakhand, often referred to as the "Land of the Gods," is a picturesque state located in the northern
            part of India. Nestled in the majestic Himalayan range, this region is renowned for its breathtaking natural
            beauty. Uttarakhand is home to some of India's most sacred and revered pilgrimage sites, including the holy
            city of Haridwar and the spiritual town of Rishikesh, both situated along the banks of the sacred Ganges
            River.
    ...
    <div class="card1">
        ...
        <div class="content" style="overflow:scroll">
            <ul>
                ...
                <li><a href="uttarakhands.php" style="font-size: 40px;">SOIL</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li><a href="uttarakhandw.php" style="font-size: 40px;">WEATHER</a></li>
            </ul>
        </div>
    </div>
    </div>
    ...
    <div class="card1">
        ...
        <div class="content">
            <ul>
                ...
                <li>Oilseeds</li>
                <li><a href="uttarakhandc.php" style="font-size: 40px;">CROPS</a></li>
            </ul>
        </div>
    </div>
